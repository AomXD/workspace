  ...
  <tr>
	...
	<strong>收银结帐</strong>   <form name="form" method="post" action="cart_checkOutOrder.jsp"  onSubmit="checkEmpty(form)">
		  <table width="68%"  border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td width="24%" height="30"><div align="center">会员姓名：</div></td>
              <td width="76%">&nbsp;<input type="text" name="rellyName"></td>
            </tr>
            <tr>
      ...
      <option value="会员卡付款">会员卡付款</option>
      <option value="现金支付">现金支付</option>
            ...
            <tr>
              ...
              <td>&nbsp;<select name="post" class="textarea">
			        <option value="">请选择</option>
      <option value="半小时">半小时之内</option>
      <option value="一个小时">一小时之内</option>
    </select>
